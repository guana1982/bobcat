...
const MEDIUMLEVEL_URL = process.env.INTELLITOWER_MEDIUMLEVEL_URL || 'http://192.168.188.204:5900/api/v0'; // 'http://93.55.118.44:5900/api/v0' // - 'http://2.34.152.134:5900/api/v0'; 
