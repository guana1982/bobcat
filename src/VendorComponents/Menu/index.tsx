...
import MenuHome from "../../components/MenuV2/MenuHome";
import MenuLauncher from "../../components/MenuV2/MenuLauncher";
import DefaultSubmenu from "../../components/MenuV2/DefaultSubmenu";
import ActionsMosaicSubmenu from "../../components/MenuV2/ActionsMosaicSubmenu";
import WifiManagement from "../../components/MenuV2/Wifi";
import BeverageConfig from "../../components/MenuV2/BeverageConfig";
import BeverageSettings from "../../components/MenuV2/BeverageSettings";
import StockShelfLife from "../../components/MenuV2/StockShelfLife";
import CleanSanitation from "./Custom/CleanSanitation";
import DailyFlush from "../../components/MenuV2/DailyFlush";
import InactivityHandler from "../../components/MenuV2/InactivityHandler";
...
const actions = {
  ...
  "init.enter": async (dispatch, update) => {
    const menus = await mediumLevel.menu.getList();
    if (!menus) {
...
class Menu extends React.Component<any, MenuState> {
  ...
  render() {
    ...
    return (
      <div>
        <Match state={stateMachine.toString()} show={IDLE}>
          <MenuLauncher
