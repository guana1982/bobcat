...
const BASE_URL = process.env.NODE_ENV === "production" ? /* "http://2.34.152.134:5900/api/v0" */ "http://192.168.188.204:5900/api/v0" : process.env.INTELLITOWER_MEDIUMLEVEL_URL;
