...
export const Beverage = memo((props: BeverageProps) => {
  ...
  const $outOfStock: boolean = status_id === BeverageStatus.EmptyBib || beverage.line_id <= 0 || beverage.$lock || ($specialCard && (beverage.$lock || (levels.carbonation_perc != null && alarmSparkling_))) || (beverage.bib_expiring_date && compareDate(beverage.bib_expiring_date));
