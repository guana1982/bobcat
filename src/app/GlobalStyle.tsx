...
export const GlobalStyle = createGlobalStyle`
  ...
  body::after{
    ...
    content:
      ...
      url("img/pay.svg")
      url("img/payment_system_down.png")
      ...
      url("icons/apple-pay.png")
      url("icons/arrow-circle.png")
      url("icons/back.svg")
      ...
      url("icons/favorite.webp")
      url("icons/favorite@blur.png")
      url("icons/favorite@blur.webp")
      url("icons/flavor.svg")
      url("icons/gift.svg")
      url("icons/info.svg")
      url("icons/last_pour.svg")
      url("icons/last_pour.webp")
      url("icons/last_pour@blur.png")
      url("icons/last_pour@blur.webp")
      url("icons/left.svg")
      url("icons/log-out.svg")
      url("icons/nutrition.svg")
      url("icons/qr-code.svg")
      url("icons/samsung-pay.png")
